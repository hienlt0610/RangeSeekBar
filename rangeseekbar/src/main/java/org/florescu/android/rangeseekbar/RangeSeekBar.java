    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            try {
                ...
                showTextAboveThumbs = a.getBoolean(R.styleable.RangeSeekBar_showThumbText, true);
                textAboveThumbsColor = a.getColor(R.styleable.RangeSeekBar_thumbTextColor, Color.WHITE);
                ...
                int defaultAboveThumbTextSize = PixelUtil.dpToPx(context, DEFAULT_TEXT_SIZE_IN_DP);
                textSize = a.getDimensionPixelSize(R.styleable.RangeSeekBar_thumbTextSize, defaultAboveThumbTextSize);
